...
(Sorry for the code without syntax highlighting in blocks of code. Notion does not export worksheets as PDFs with code highlighting. You can check the [original page](Data%20Querying.md) where the code is properly highlighted)

# SQL queries for database definition
...
![Untitled](../media/query_1.png)

![Untitled](../media/query_2.png)

![Untitled](../media/query_3.png)

![Untitled](../media/query_4.png)