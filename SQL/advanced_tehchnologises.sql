-- VIEWS: https://www.youtube.com/watch?v=wciubfRhvtM
-- INDEX: https://youtu.be/LpEwssOYRKA
-- TRANSACTIONS: https://www.youtube.com/watch?v=H0cl2DMNdqo
...
-- This table is big (~ 38k ) and index helps us make queries faster. 
-- We should update index after every competition (after adding all results of competition)
CREATE INDEX leaderboard_place
